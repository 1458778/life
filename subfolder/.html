...
<head>
    ...
    <meta name="publicationPath" content="/api/1.0/github/exec/put/hack">
...
<body data-silex-id="body-initial" class="body-initial silex-runtime" data-silex-type="container">
    ...
    <div data-silex-type="container" class="prevent-draggable container-element editable-style silex-id-1478366444112-1 section-element" data-silex-id="silex-id-1478366444112-1" style="">
        ...
        <div data-silex-type="text" class="editable-style silex-id-1508969580562-2 text-element" data-silex-id="silex-id-1508969580562-2" style="">
            <div class="silex-element-content normal">Good... you can follow directions. You won't end up like the others then.
                <div>
                    <div><br></div>
                    <div>You won't end up like Kevin.</div>
                    <div><br></div>
                    <div><br></div>
                    <div><br></div>
                    <div>My name is Lifehacker as you should know by now, and you are my glitch.</div>
                    <div><br></div>
                    <div>Think of it this way.&nbsp;</div>
                    <div><br></div>
                    <div><br></div>
                    <div>Life as you know it doesn't exist. You and everything else are made up of binary.</div>
                    <div><br></div>
                    <div>Binary that is manipulated and controlled by a society you so desperately tried to make.</div>
                    <div><br></div>
                    <div>Then I came along. I took initiative.</div>
                    <div><br></div>
                    <div>
                        <font face="courier new, monospace" style="background-color: rgb(238, 238, 238);">I hacked life.</font>
                    </div>
                    <div><br></div>
                    <div>And now, you. You are me, and I will never be you.</div>
                    <div><br></div>
                    <div>You are an influence of me that life won't accept. A glitch.</div>
                    <div><br></div>
                    <div>The life you're saving is your own.&nbsp;</div>
                    <div><br></div>
                    <div><br></div>
                    <div>Now that you know, I will ask again, and you can reply to me.</div>
                    <div><br></div>
                    <div><br></div>
                    <div>Would you like to save a life?</div>
                </div>
                <div><br></div>
            </div>
        </div>
    ...
    <div data-silex-type="container" class="prevent-draggable container-element editable-style silex-id-1478366450713-3 section-element" data-silex-id="silex-id-1478366450713-3" style="">
        <div data-silex-type="container" class="editable-style silex-element-content silex-id-1478366450713-2 silex-container-content container-element prevent-draggable website-width" data-silex-id="silex-id-1478366450713-2">
            ...
            <div data-silex-id="silex-id-1442914737143-3" class="editable-style silex-id-1442914737143-3 text-element" data-silex-type="text" style="">
                <div class="silex-element-content normal"><br>
                </div>
            </div>
        </div>
    </div>
